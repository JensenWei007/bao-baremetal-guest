...
void renesas_rlin3_uart_enable(volatile struct renesas_rlin3* uart);
void renesas_rlin3_uart_init(volatile struct renesas_rlin3* uart);
void renesas_rlin3_uart_putc(volatile struct renesas_rlin3* uart, int8_t c);
